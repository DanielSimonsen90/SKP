import { BaseProps, useLocalStorage, UseStateReturn, UseStateSetState } from "danholibraryrjs";
...
const SettingsContext = createContext<SettingsContext>([
    { darkmode: true, language: "English", preferCards: false },
    () => ({ darkmode: true, language: "English", preferCards: false })
]);
...
export default function SettingsProvider({ children }: BaseProps) {
    const defaultSettings = useMemo<Settings>(() => ({ darkmode: true, language: "English", preferCards: false }), []);
